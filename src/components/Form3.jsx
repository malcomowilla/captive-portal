...
const Form3 = () => {
  ...
  const {loading, hasPaid3, error, form3, setForm3 , phoneNumber3,  setPhoneNumber3,
     handleSubmit3, setError, sethasPaid3} = useContext(LoaderContext)
...
{hasPaid3 && 
  ...
  <div  onClick={()=>sethasPaid3(!hasPaid3) } role="alert" className="alert alert-success">
