...
const Form = ({form, setForm, amount, setAmount , phoneNumber,  setPhoneNUmber, handleSubmit}) => {
  ...
  return (
    ...
    <div className="w-[500px]  aspect-[10/5] m-auto relative max-sm:top-[200px]
...
<input type="text" className="border-2 w-fit rounded-2xl outline-none"   name="phone_number" value={phoneNumber} onChange={(e)=> setPhoneNUmber(e.target.value)}/><br /><br />
<label >Amount</label>
<input type="number" className="border-2 w-fit  rounded-2xl translate-y-[-5px] outline-none" value={amount} onChange={(e)=> setAmount(e.target.value)} />
